...
public:
	...
	/* Resize array to store more objects */
	void ResizeObjectArray(int iNewNumberObjects);
...
private:
	...
	/* mxh03u: Vector of displayable objects */
	std::vector<DisplayableObject*> m_vpDisplayableObjects;
